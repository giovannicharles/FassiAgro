@extends('layouts.app')
@section('title', 'Tableau de bord Acheteur | FassiAgro')
@section('style')
        ...
        <header class="bg-white border-b border-gray-200 p-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex items-center">
                        <span class="text-gray-700 mr-2 hidden md:inline"> {{ $user_name }} </span>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Maïs</td>
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Cacao</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2 tonnes</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Sud</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Riz</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">10 tonnes</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Nord</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
...
@section('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.body.classList.add('bg-gray-50', 'flex h-screen', 'overflow-hidden');
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (chartCanvas) {
                ...
                chartCanvas.innerHTML =
                    '<div class="flex items-center justify-center h-full text-gray-400"><p>Graphique des prix du maïs</p></div>';
            }
        });
